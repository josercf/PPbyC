...
@IonicPage()
@Component({
    selector: 'page-agente-alocacao',
    templateUrl: 'agente-alocacao.html',
    providers: []
})
export class AgenteAlocacaoPage {
    ...
    consultarAvaliacao() {
        ...
        if (this.abordagem) {
            this.agenteService.consultarDetalhe(this.jwt.sid, this.abordagem, this.agente.Id).subscribe(response => {
